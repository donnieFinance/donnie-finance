...
const START_TIME = 1620086400;      // 20210504:09:00(Seoul) in Seconds. 참조- https://www.epochconverter.com/ 배포 addr:ContractB6RmuvfZy2YskreyMaewsdUSPdvhjNSqueZdbuhNS7AE
...
class DonHusdPool {
    ...
    stake(amount) {
        ...
        blockchain.callWithAuth(HUSD_ADDRESS, "transfer", [STAKE_TOKEN,  tx.publisher, blockchain.contractName(), amount, "stake"]);
    }
    ...
    withdraw(amount) {
        ...
        blockchain.callWithAuth(HUSD_ADDRESS, "transfer", [STAKE_TOKEN, blockchain.contractName(), tx.publisher,  amount, "withdraw"]);
    }

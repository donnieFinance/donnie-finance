...
//iwERC토큰은 ADDRESS 이용해서 전송 필요.
const STAKE_TOKEN = 'iwbly';                                                     //TODO3 prod
const STAKE_TOKEN_ADDRESS = 'ContractA41qesco7HC9scMs7cbD58H8ekBPSfXaWJiEwa3VFedR'; //TODO4 prod :

const RATIO = 1000;  //1 ticket per 5000 bly
...
const DURATION = 24 * 3600 * 99999;    //중요치 않음- 사용가능성이 있어 저장 중.  14일 in Seconds
...
class IdoTicketBlyPool {
    ...
    withdrawWithTicket(ticketCount) {
        ...
        blockchain.callWithAuth(STAKE_TOKEN_ADDRESS, "transfer", [STAKE_TOKEN, blockchain.contractName(), tx.publisher, amount, "withdrawWithTicket"]);
    }
...
module.exports = IdoTicketBlyPool;